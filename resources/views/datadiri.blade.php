        ...
        <div class="row">
            <div class="col">
                <div class="form-group  mt-5">
                        ...
                        <input name="checkin" type="date" class="form-control mt-4" placeholder="Check-in" aria-label="First name">
                        <input name="jml_kamar" type="text" class="form-control mt-4" placeholder="Lama Hari" aria-label="First name">
