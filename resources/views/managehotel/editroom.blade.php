            ...
            <div class="col-lg-9 mx-auto">
                <form action="/managehotel/update/{{$rooms->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="name" class="form-control" required="required" name="tipe"
                            value="{{$rooms->tipe}}"><br>
                    </div>
                    <div class="form-group">
                        <label for="price">Harga</label>
                        <input type="text" class="form-control" required="required" name="price"
                            value="{{$rooms->price}}"><br>
                    </div>
                    <div class="form-group">
                        <label for="room_left">Password</label>
                        <input type="text" class="form-control" required="required" name="room_left"
                            value="{{$rooms->room_left}}"><br>
                    </div>
                    <div class="form-group">
                        <label for="fasilitas">Fasilitas</label>
                        <input type="text" class="form-control" required="required" name="fasilitas"
                            value="{{$rooms->fasilitas}}"><br>
                    </div>
                    <div class="form-group">
                        <label for="image">Gambar Ruangan</label>
                        <input type="file" class="form-control" required="required" name="image"
                            value="{{$rooms->picture}}"><br>
