            ...
            <div class="col-lg-9 mx-auto">
                <form action="/managehotel/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="required" name="tipe"><br>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="required" name="room_left"><br>
                    </div>
                    <div class="form-group">
                        <label for="fasilitas">Fasilitas</label>
                        <input type="text" class="form-control" required="required" name="fasilitas"><br>
                    </div>
                    <div class="form-group">
